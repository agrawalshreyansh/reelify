                    ...
                    <div className="flex flex-col w-[64vw] py-8 my-6 px-8 bg-white/10 shadow-lg shadow-[rgba(31,38,135,0.37)] backdrop-blur-[4.5px] rounded-[10px]  border border-white/18">
                        <div className="flex w-[100%]">
                            <div className="w-[50%] m-8">
                                ...
                                <div className="flex flex-col h-64 justify-center items my-4">
                                    <label htmlFor="fullname" className="text-white">Description</label>
                                    <textarea className="border-2 border-primary text-white p-2 h-[100%]  rounded-xl " />
                                </div>
                            </div>
                            <div className="w-[50%] m-8 flex flex-col items-center justify-center">
                        ...
                        <div className="flex items-center justify-center">
                            <button className="cursor-pointer w-[40%] text-primary bg-highlight rounded-3xl h-10 mt-8 ">Upload</button>
                        </div>
                    </div>
                </div>
            </div>
